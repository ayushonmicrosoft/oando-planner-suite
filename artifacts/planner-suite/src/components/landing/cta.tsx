...
export default function CTA({ onGetStarted }: CTAProps) {
  return (
    <section className="py-24 lg:py-32 bg-[#070D12] relative overflow-hidden" aria-label="Call to action">
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-[#5488B6]/[0.06] rounded-full blur-[120px]" />
      </div>
      ...
      >
        ...
        <h2 className="text-[32px] md:text-[48px] font-semibold text-white mb-6 tracking-[-0.02em]">
          Ready to Design Your
          <br />
          Perfect Workspace?
        </h2>
        <p className="text-[17px] text-white/40 mb-10 max-w-[480px] mx-auto leading-relaxed">
        ...
        <p className="text-[13px] text-white/20 mt-6">No credit card required</p>
      </motion.div>
    </section>
  );
}
