      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <Card className="bg-gradient-to-r from-primary/5 to-primary/10 border-primary/20">
          <CardContent className="flex flex-col sm:flex-row items-center justify-between gap-4 py-5">
            ...
            <Button className="gap-2 shrink-0" onClick={() => setLocation('/templates')}>
        ...
        <Card className="bg-gradient-to-r from-green-500/5 to-emerald-500/10 border-green-500/20">
          <CardContent className="flex flex-col sm:flex-row items-center justify-between gap-4 py-5">
            ...
            <Button variant="outline" className="gap-2 shrink-0" onClick={() => setLocation('/tools/site-plan')}>
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <Card className="border-primary/20 hover:border-primary/50 transition-colors shadow-sm">
            ...
            <CardFooter>
              <Button className="w-full" onClick={() => setLocation('/planner/canvas')} data-testid="button-start-canvas">
                Start Empty Canvas
              </Button>
            </CardFooter>
          </Card>
          ...
          <Card className="border-primary/20 hover:border-primary/50 transition-colors shadow-sm">
            ...
            <CardFooter>
              <Button className="w-full" variant="secondary" onClick={() => setLocation('/planner/blueprint')} data-testid="button-start-blueprint">
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
          <Card className="hover:border-primary/50 transition-colors shadow-sm">
            ...
            <CardFooter>
              <Button className="w-full" size="sm" onClick={() => setLocation('/tools/cad')} data-testid="button-start-cad">
                Start
              </Button>
            </CardFooter>
          </Card>
          ...
          <Card className="hover:border-primary/50 transition-colors shadow-sm">
            ...
            <CardFooter>
              <Button className="w-full" size="sm" onClick={() => setLocation('/tools/floor-plan')} data-testid="button-start-floor-plan">
                Start
              </Button>
            </CardFooter>
          </Card>
          ...
          <Card className="hover:border-primary/50 transition-colors shadow-sm">
            ...
            <CardFooter>
              <Button className="w-full" size="sm" onClick={() => setLocation('/tools/shapes')} data-testid="button-start-shapes">
                Start
              </Button>
            </CardFooter>
          </Card>
          ...
          <Card className="hover:border-primary/50 transition-colors shadow-sm">
            ...
            <CardFooter>
              <Button className="w-full" size="sm" onClick={() => setLocation('/tools/site-plan')} data-testid="button-start-site-plan">
                Start
              </Button>
            </CardFooter>
          </Card>
          ...
          <Card className="hover:border-primary/50 transition-colors shadow-sm">
            ...
            <CardFooter>
              <Button className="w-full" size="sm" onClick={() => setLocation('/tools/import')} data-testid="button-start-import">
                Start
              </Button>
            </CardFooter>
          </Card>
            ...
            {recentPlans.map((plan) => {
              ...
              return (
                <Card key={plan.id} className="hover:bg-muted/50 transition-colors">
                  ...
                  <CardFooter>
                    <Button variant="secondary" className="w-full" onClick={() => setLocation(`${plannerTypeRoutes[plan.plannerType] || '/planner/canvas'}?id=${plan.id}`)} data-testid={`button-open-plan-${plan.id}`}>
                      Open Plan
                    </Button>
                  </CardFooter>
                </Card>
          ...
          <Card className="bg-muted/30 border-dashed">
            <CardContent className="flex flex-col items-center justify-center h-48 text-center text-muted-foreground">
              ...
              <div className="flex gap-4 mt-4">
                <Button size="sm" onClick={() => setLocation('/planner/canvas')}>Start Canvas</Button>
                <Button size="sm" variant="secondary" onClick={() => setLocation('/planner/blueprint')}>Start Blueprint</Button>
              </div>
            </CardContent>
          </Card>
        )}
